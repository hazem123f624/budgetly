<form id="receivableAddForm" method="POST" action="{{ route('receivables.store') }}" class="space-y-6">
    @csrf

    <!-- Header Section -->
    <div class="text-center border-b border-gray-200 pb-4">
        <h3 class="text-lg font-semibold text-gray-900">إضافة مستحق جديد</h3>
        <p class="text-sm text-gray-600 mt-1">إضافة مستحق جديد إلى قائمة المستحقات</p>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const form = document.getElementById('receivableAddForm');
    if (form) {
