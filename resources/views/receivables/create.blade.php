...
@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">إضافة مستحق جديد</h1>
        <p class="text-gray-600 mt-2">إضافة مستحق جديد إلى قائمة المستحقات</p>
    </div>
    ...
    <div class="rounded-lg border-2 border-dashed border-gray-300 p-12 text-center">
        ...
        <h3 class="mt-2 text-sm font-medium text-gray-900">إضافة مستحق جديد</h3>
        <p class="mt-1 text-sm text-gray-500">اضغط على الزر أدناه لإضافة مستحق جديد</p>
        <div class="mt-6">
            <button onclick="openReceivableAdd()"
...
function openReceivableAdd() {
    ...
    fetch(`/receivables/add-snippet?budget=${budgetId}`, {
        method: 'GET',
        headers: {
